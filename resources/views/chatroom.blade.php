    ...
    <div class="row">
        @foreach($chatrooms as $chatroom)
            ...
            <div class="col-md-4 mb-3">
                <div class="card">
                    <img src="{{ $friend->profile_picture ?: asset('assets/default-profile.jpg') }}" class="card-img-top" style="width: 8rem; height: 8rem;" alt="Profile Picture">
                    <div class="card-body">
                        <h5 class="card-title">{{ $friend->name }}</h5>
                        <p class="card-text">@lang('lang.field_of_work'): {{ $friend->field_of_work }}</p>
