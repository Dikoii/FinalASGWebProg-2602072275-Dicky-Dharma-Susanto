        ...
        @forelse($acceptedFriends as $friendship)
            <div class="col">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        <h5 class="mb-2">Name: {{ $friendship->sender_id == Auth::id() ? $friendship->receiver->name : $friendship->sender->name }}</h5>
                        <p class="mb-2">Field of Work: {{ $friendship->sender_id == Auth::id() ? $friendship->receiver->field_of_work : $friendship->sender->field_of_work }}</p>
                        <p class="mb-2">Gender: {{ $friendship->sender_id == Auth::id() ? $friendship->receiver->gender : $friendship->sender->gender }}</p>
