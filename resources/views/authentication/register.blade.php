        ...
        <div class="col-md-8">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="mb-2">
                    ...
                    <input type="text" class="form-control @error('field_of_work') is-invalid @enderror" id="field_of_work" name="field_of_work" value="{{ old('field_of_work') }}" placeholder="Enter at least 3 fields e.g., scientist, doctor, teacher" required>
                    @error('field_of_work')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
