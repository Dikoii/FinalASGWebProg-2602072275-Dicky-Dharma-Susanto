    ...
    <form method="POST" action="{{ route('processPayment') }}">
        ...
        <div class="mb-3">
            ...
            <input 
                ...
                value="{{ old('amount', session('previousAmount')) }}" 
                required>
            @error('amount')
...
<script>
    @if(session('confirmationNeeded'))
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.getElementById('overpaymentMessage').innerText = "You overpaid by Rp " + overpaymentAmount + ". Would you like to confirm?";
